...
$app->post('/api/PayPal/deleteWebhook', function ($request, $response, $args) {
    ...
    if(isset($post_data['args']['sandbox']) && $post_data['args']['sandbox'] == 1) {
        $query_str = 'https://api.sandbox.paypal.com/v1/notifications/webhooks/'.$post_data['args']['webhookId'];
    } else {
        $query_str = 'https://api.paypal.com/v1/notifications/webhooks/'.$post_data['args']['webhookId'];
    }
