...
$app->post('/api/PayPal/reactivateAgreement', function ($request, $response, $args) {
    ...
    if(isset($post_data['args']['sandbox']) && $post_data['args']['sandbox'] == 1) {
        $query_str = 'https://api.sandbox.paypal.com/v1/payments/billing-agreements/'.$post_data['args']['agreementId'].'/re-activate';
    } else {
        $query_str = 'https://api.paypal.com/v1/payments/billing-agreements/'.$post_data['args']['agreementId'].'/re-activate';
    }
