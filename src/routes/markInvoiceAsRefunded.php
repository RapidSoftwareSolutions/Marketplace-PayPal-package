...
$app->post('/api/PayPal/markInvoiceAsRefunded', function ($request, $response, $args) {
    ...
    if($post_data['args']['sandbox'] == 1) {
        $query_str = 'https://api.sandbox.paypal.com/v1/invoicing/invoices/'.$post_data['args']['invoiceId'].'/record-refund';
    } else {
